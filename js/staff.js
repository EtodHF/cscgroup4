...
document.addEventListener("DOMContentLoaded", () => {
    const staff = [
      { name: "----", role: "Head of Department", img: "images/hod.jpg" },
      { name: "Dr I. I Ayogu", role: "Course Advisor", img: "images/gallery2.jpg" },
      { name: "Dr Nwokoma", role: "Lecturer", img: "images/drNwokoma.jpg" },
    ];
